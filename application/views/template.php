...
<head>
    ...
    <!-- myicon -->
    <link rel="icon" href="assets/dist/img/heejra.png">
    <!--[if lt IE 9]>
    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="<?=base_url('dashboard')?>" class="logo">
                <span class="logo-mini"><img src="assets/dist/img/heejra.png" width="50%"></span>
                <span class="logo-lg"><b>heejra</b> Counter</span>
            </a>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?=base_url()?>assets/dist/img/me.jpg" class="user-image">
                                <span class="hidden-xs"><?=$this->fungsi->user_login()->username?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="user-header">
                                    <img src="<?=base_url()?>assets/dist/img/me.jpg" class="img-circle">
            ...
            <section class="sidebar">
                <div class="user-panel">
                    ...
                    <div class="pull-left info">
                        ...
                        <a href="#"><i class="fa fa-circle text-success"></i> <?=$this->fungsi->user_login()->name?></a>
                    </div>
                </div>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; <?php echo date("Y")?> <a href="">heejra</a>.</strong> All rights reserved.
        </footer>
