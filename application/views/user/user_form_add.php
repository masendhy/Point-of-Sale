                ...
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group <?=form_error('username') ? 'has-error' : null?>">
                            ...
                            <input type="text" name="username" placeholder="set to admin or counter"
                                value="<?=set_value('username')?>" class="form-control">
                            <?=form_error('username')?>
                        </div>
                        <div class="form-group <?=form_error('password') ? 'has-error' : null?>">
                            <label>Password *</label>
                            <input type="password" name="password" placeholder="at least 5 characters"
                        ...
                        <div class="form-group <?=form_error('passconf') ? 'has-error' : null?>">
                            ...
                            <input type="password" name="passconf" placeholder="at least 5 characters"
                        ...
                        <div class="form-group <?=form_error('level') ? 'has-error' : null?>">
                            ...
                            <select name="level" class="form-control">
                                ...
                                <option value="2" <?=set_value('level') == 2 ? "selected" : null?>>Counter</option>
                            </select>
                            <?=form_error('level')?>
                        </div>
                        <div class="form-group">
